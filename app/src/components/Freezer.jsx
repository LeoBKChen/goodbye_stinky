...
export default class Freezer extends React.Component {
    ...
    componentDidMount() {
        ...
        if(tooltip1){
            tooltip1.addEventListener('mouseover',this.handleTooltipToggle);
        }
        if(tooltip2){
            tooltip2.addEventListener('mouseover',this.onMouseOverTooltip);
        }
        if(tooltip3){
            tooltip3.addEventListener('mouseover',this.onMouseOverTooltip);
        }
        if(tooltip4){
            tooltip4.addEventListener('mouseover',this.onMouseOverTooltip);
        }
        if(tooltip5){
            tooltip5.addEventListener('mouseover',this.onMouseOverTooltip);
        }
        if(tooltip6){
            tooltip6.addEventListener('mouseover',this.onMouseOverTooltip);
        }
        if(tooltip7){
            tooltip7.addEventListener('mouseover',this.onMouseOverTooltip);
        }
            ...
            <div className='freezer'>
                <Card>
                    <div>
                        ...
                        <h1>forcsssssssss</h1>
                        <div className='第一'>
                            <i id='addItem' className='fa fa-plus'  onClick={() => this.handleTooltipToggle}></i>
                        </div>
                        <div className='第一' >
                        ...
                        <div className='d-flex flex-column'>
                            <Tooltip placement='top' isOpen={this.state.tooltipOpen6} autohide={false} target='meatTooltip' toggle={this.handleTooltipToggleEgg}>
                                <img className='eggMilk' src={getfoodIcon("蛋")}   onClick={() => this.handleCreate("蛋/乳製品","蛋")} />&nbsp;
                                <img className='eggMilk' src={getfoodIcon("牛奶")} onClick={() => this.handleCreate("蛋/乳製品","牛奶")}   />&nbsp;
                                <img className='eggMilk' src={getfoodIcon("起司")} onClick={() => this.handleCreate("蛋/乳製品","起司")} /> 
                            </Tooltip>
                        </div>
                        <div className='d-flex flex-column'>
